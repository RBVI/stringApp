 ...
 */
public class JColorChooserBrewer
	extends JDialog
{
...
//----------------------------------------------------------------------
	 ...
	 */
	public JColorChooserBrewer( final Frame parent )
	{
	 ...
	 */
	public JColorChooserBrewer( final Dialog parent )
	{
		super( parent, true );		// Always modal
	...
	// This may need to change if the number of Brewer panels changes
	ColorBlindAwareColorChooserPanel[] panels = new ColorBlindAwareColorChooserPanel[1];
	...
	protected void initialize( )
	{
		...
		panels[0] = new QualitativeColorPanel();
		newPanels[0] = panels[0];
...
//----------------------------------------------------------------------
	...
	public static void main(String[] args){
		JColorChooserBrewer d = new JColorChooserBrewer();
		d.show();
	}
}
